...
const OrderSummary = ({ restaurant, cartItems, removeFromCart }: PropsType) => {
  const getTotalCost = () => {
    ...
    const totalCartCostWithDelivery = totalCartCost + restaurant.deliveryPrice;
    return totalCartCostWithDelivery.toFixed(2);
  };
  return (
    <>
      <CardHeader>
